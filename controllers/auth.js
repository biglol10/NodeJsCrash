...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  // Get reset token
  // user.getreset => defined method inside the model
...
exports.resetPassword = asyncHandler(async (req, res, next) => {
  ...
  // Set new password
  // it is going to be encrypted because of UserSchema.pre("save", async function (next)
  user.password = req.body.password;
  user.resetPasswordToken = undefined; // by setting to undefined the value just goes away
  user.resetPasswordExpire = undefined;
  await user.save();
